...
urlpatterns = [
    ...
    path('owner_profile/update_picture/', update_profile_picture_owner, name='update_profile_picture'),
    path('update_profile_picture/', update_profile_picture_user, name='update_profile_picture'),
